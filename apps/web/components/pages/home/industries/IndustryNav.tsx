 ...
 */
export const IndustryNav = ({ sectors, activeIndex }: InustryNavProps) => {
    return (
        <div className="absolute hidden sm:flex left-0 top-1/2 -translate-y-1/2 z-20 flex-col gap-4">
                    ...
                    <div key={sector.id} className="group flex items-center gap-3 justify-end">
                        ...
                        <motion.div
                            animate={{
                                ...
                                backgroundColor: isActive ? "#D9C073" : "#000",
                            }}

    ...
    return (
        <GridItem>
            ...
            <div className="grid grid-cols-3">
                ...
                <div>
                    <h3 className="text-xs text-background/50 font-medium mb-4">Industries</h3>
                    <LinksList links={FOOTER_LINKS.industries} />
                </div>
                <div>
                    <h3 className="text-xs text-background/50 font-medium mb-4">Materials</h3>
...
const Footer = () => {
    return (
        <footer className="bg-foreground pt-24 relative overflow-hidden">
            ...
            <GlowOrb id="br" className="opacity-30 -top-150 -left-150" />
            <GlowOrb id="bl" className="opacity-30 -right-150  -bottom-150" />
            <Container className="relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-12 mt-12">
                    ...
                    <Fade delay={.3} className="col-span-2">
